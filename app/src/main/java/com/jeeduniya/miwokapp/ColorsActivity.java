...
public class ColorsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final ArrayList<Word> colorArrayList = new ArrayList<>();
        ...
        WordAdapter colorAdapter = new WordAdapter(this, colorArrayList, R.color.category_colors);
...
//      Set a click listener to play the audio when the list item is clicked on
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                ...
                mMediaPlayer = MediaPlayer.create(ColorsActivity.this, word.getAudioResourceId());//getAudioResourceId() is a method in our Word class that we've created
